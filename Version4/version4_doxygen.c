/**
* @file version4_doxygen.c
* @brief Programme snake version 4, commentaires doxygen
...
/**
 * \def HAUT
 * \brief constante pour direction HAUT du serpent
 */
#define HAUT 'z'
/**
 * \def GAUCHE
 * \brief constante pour direction GAUCHE du serpent
 */
#define GAUCHE 'q'
/**
 * \def BAS
 * \brief constante pour direction BAS du serpent
 */
#define BAS 's'
/**
 * \def DROITE
 * \brief constante pour direction DROITE du serpent
 */
#define DROITE 'd'
...
/**
 * \typedef aireDeJeu
 * \brief tableau a double entrée, plateau de jeu
 * plateau sur lequel sera placé le serpent, les bordures, les pommes et les pavés
 */
...
/**
 * \var plateau
 * \brief plateau de type aireDeJeu
 * variable globale du platau de jeu
 */
...
int main()
{
    ...
    int temps=TEMPS;/**Vitesse de déplacement du serpent*/
...
{	
    /**
     * @fn progresser(int lesX[], int lesY[], char direction, bool *collision, bool *mangePomme)
...
{
	/**
	 * @fn teleportation (int lesX[], int lesY[])
...
{
	/**
	 * @fn afficherPlateau(aireDeJeu plateau)
...
{
	/**
	 * @fn initPlateau(aireDeJeu plateau, int lesX[], int lesY[])
...
{
    /**
     * @fn initPaves(aireDeJeu plateau, int lesX[], int lesY[]) 
...
{
    /**
     * @fn ajouterPomme(aireDeJeu plateau, int lesX[], int lesY[], int tailleSerpent) 
